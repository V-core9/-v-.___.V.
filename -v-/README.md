...
_See code: [src/commands/sample_check-ip.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_check-ip.js)_
...
_See code: [src/commands/sample_get-public-ip.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_get-public-ip.js)_

## `-v- sample_get-supports_sixel`
...
_See code: [src/commands/sample_get-supports_sixel.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_get-supports_sixel.js)_

## `-v- sample_get-unicode-version`
...
_See code: [src/commands/sample_hello.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_hello.js)_
...
_See code: [src/commands/sample_is-cmd.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_is-cmd.js)_
...
_See code: [src/commands/sample_is-wsl.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_is-wsl.js)_
...
_See code: [src/commands/sample_speedtest.net.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_speedtest.net.js)_

## `-v- sample_volume-set [VOLLEVEL]`
...
_See code: [src/commands/sample_volume-set.js](https://github.com/MyUserNameIsMyUserName/-v-/blob/v1.2.7/src/commands/sample_volume-set.js)_
...
WebPageTest API Wrapper [NO API KEY]
