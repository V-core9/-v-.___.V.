/*!
 * fireworks-js 1.2.2 by Vitalij Ryndin (https://crashmax.ru)
    ...
    return (()=>{
        ...
        var t = {
            594: (t,i,s)=>{
                ...
                i.Explosion = class {
                    constructor(t) {
                        var {x: i, y: s, ctx: n, hue: h, friction: o, gravity: a, explosionLength: r, brightness: _} = t;
                        ...
                        this._friction = o,
                        this._gravity = a,
                        this._explosionLength = r; this._explosionLength--; )
                            this._coordinates.push([i, s]);
                        this._angle = (0,
                        e.randomFloat)(0, 2 * Math.PI),
                        this._speed = (0,
                        e.randomInteger)(1, 10),
                        this._hue = (0,
                        e.randomInteger)(h - 20, h + 20),
                        this._brightness = (0,
                        e.randomInteger)(_.min, _.max),
                        this._decay = (0,
                        e.randomFloat)(_.decay.min, _.decay.max)
                    }
                    update(t) {
                            ...
                            if (this.options.enable)
                                if (this._buffer.length) {
                                    var t = this._audioContext.createBufferSource()
                                      , i = this._buffer[(0,
                                    n.randomInteger)(0, this._buffer.length - 1)]
                                      , s = this._audioContext.createGain();
                                    t.buffer = i,
                                    s.gain.value = (0,
                                    n.randomFloat)(this.options.volume.min / 100, this.options.volume.max / 100),
            ...
            377: (t,i,s)=>{
                ...
                i.Trace = class {
                    constructor(t) {
                        var {x: i, y: s, dx: n, dy: h, ctx: o, hue: a, speed: r, acceleration: _, traceLength: c} = t;
                        for (this._coordinates = [],
                        ...
                        this._traceLength = c,
                        this._totalDistance = this.getDistance(i, s, n, h); this._traceLength--; )
                            this._coordinates.push([i, s]);
                        this._angle = Math.atan2(h - s, n - i),
                        this._brightness = (0,
                        e.randomInteger)(50, 70)
                    }
                    update(t) {
                        this._coordinates.pop(),
                        this._coordinates.unshift([this._x, this._y]),
            ...
            485: (t,i,s)=>{
                ...
                i.randomInteger = i.randomFloat = void 0;
                var e = s(461);
        ...
        function s(e) {
            ...
            return t[e].call(h.exports, h, h.exports, s),
            h.exports
        }
        var e = {};
        return (()=>{
            ...
            t.Fireworks = class {
                constructor(t) {
                    var {acceleration: i, autoresize: s, boundaries: e, brightness: h, delay: o, explosion: a, friction: r, gravity: _, hue: c, mouse: d, particles: u, sound: l, speed: x, rocketsPoint: p, trace: g} = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this._tick = 0,
                    this._version = "1.2.2",
                    this._running = !1,
                    this._visibleBoundaries = !1,
                    ...
                    this._sound = new n.Sound(l),
                    this.setSize(),
                    this.setBoundaries(Object.assign({
                        x: 50,
                        y: 50
                    }, e)),
                    this._rocketsPoint = null != p ? p : 50,
                    this._speed = null != x ? x : 2,
                    this._acceleration = null != i ? i : 1.05,
                    this._friction = null != r ? r : .95,
                    this._gravity = null != _ ? _ : 1.5,
                    this._particleCount = null != u ? u : 50,
                    this._traceLength = null != g ? g : 3,
                    this._explosionLength = null != a ? a : 5,
                    this._autoresize = null == s || s,
                    this._hue = Object.assign({
                        min: 0,
                        max: 360
                    }, c),
                    this._mouse = Object.assign({
                        click: !1,
                        move: !1,
                        max: 3
                    }, d),
                    this._delay = Object.assign({
                        min: 15,
                        max: 30
                    }, o),
                    this._brightness = Object.assign({
                        min: 50,
                        max: 80,
                        decay: {
                            min: .015,
                    ...
                    this._autoresize && window.addEventListener("resize", (()=>this.setSize())),
                    this._canvas.addEventListener("mousedown", (t=>this.useMouse(t, this._mouse.click))),
                ...
                clear() {
                    this._ctx && (this._traces = [],
                    this._explosions = [],
                    this._ctx.clearRect(0, 0, this._width, this._height))
                }
                setOptions(t, i) {
                    if ("sound" === t)
                        Object.assign(this._sound.options, i);
                    else
                        "object" == typeof i ? Object.assign(this["_".concat(t)], i) : this["_".concat(t)] = i
                }
                setSize() {
                ...
                useMouse(t, i) {
                    (this._mouse.click || this._mouse.move) && (this._mx = t.pageX - this._canvas.offsetLeft,
                    this._my = t.pageY - this._canvas.offsetTop,
                    this._m = i)
                }
                render() {
                    this._ctx && this._running && (requestAnimationFrame((()=>this.render())),
                    this._visibleBoundaries && (this._ctx.beginPath(),
                    this._ctx.strokeStyle = "red",
                    this._ctx.rect(this._boundaries.x, this._boundaries.y, this._boundaries.width - 2 * this._boundaries.x, .5 * this._boundaries.height),
                    this._ctx.stroke()),
                ...
                initTrace() {
                    this._ds = (0,
                    o.randomInteger)(this._delay.min, this._delay.max),
                    (2 * this._ds < this._tick || this._m && this._mouse.max > this._traces.length) && (this._traces.push(new i.Trace({
                        x: this._width * (this._randomRocketsPoint ? (0,
                        o.randomInteger)(0, 100) : this._rocketsPoint) / 100,
                        y: this._height,
                        dx: this._m || this._mouse.move ? this._mx : (0,
                        o.randomInteger)(this._boundaries.x, this._boundaries.width - 2 * this._boundaries.x),
                        dy: this._m || this._mouse.move ? this._my : (0,
                        o.randomInteger)(this._boundaries.y, .5 * this._boundaries.height),
                        ctx: this._ctx,
                        hue: (0,
                        o.randomInteger)(this._hue.min, this._hue.max),
                        speed: this._speed,
                ...
                initExplosion(t, i, s) {
                    for (var e = this._particleCount; e--; )
                        this._explosions.push(new h.Explosion({
                            x: t,
                            y: i,
                            ctx: this._ctx,
                            hue: s,
...
/// YEA I KNOW IT"S SUPER  BAD EXAMPLE